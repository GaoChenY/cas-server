...
<div id="login">
	<form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
		...
		<section class="row">
			...
			<c:choose>
				...
				<c:otherwise>
					...
					<form:input cssClass="required" cssErrorClass="error" id="username" size="25" tabindex="1" placeholder="用户名" accesskey="${userNameAccessKey}" path="username" autocomplete="off" htmlEscape="true" />
				</c:otherwise>
			</c:choose>
		</section>
		<section class="row">
			...
			<form:password cssClass="required" cssErrorClass="error" id="password" size="25" tabindex="2" path="password" placeholder="密码" accesskey="${passwordAccessKey}" htmlEscape="true" autocomplete="off" />
		...
		<section class="row">
			...
			<form:input cssClass="required" cssErrorClass="error" id="captcha" size="10" tabindex="3" path="captcha" placeholder="验证码" accesskey="${captchaAccessKey}" autocomplete="off" htmlEscape="true" />
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<img alt="${captchaHolder }" src="captcha.jpg" onclick="this.src='captcha.jpg?'+Math.random();" style="width: 65px; height: 30px; vertical-align: middle;">
		</section>
